...
<script>
    export default {
        ...
        created() {
            ...
            //加载会员卡账户
            this.$http.get(this.$store.state.api_url + 'api/user/user_card_account/'+id)
                .then(response => {
                    this.$store.state.response.ok(response, (data) => {
                        ...
                        if(data){
                            ...
                            this.bus_shop_list=data.bus_shop_card_account;
                        }
        ...
        methods: {
            ...
            get_data(page){
                ...
                if (!this.record_list_loading&&this.record_list_loadmore) {
                    ...
                    this.$http.get(this.$store.state.api_url + 'api/user/user_card_account_record/'+this.$route.params.id, {params: ajaxData})
                        .then(response => {
                            this.$store.state.response.ok(response, (data) => {
